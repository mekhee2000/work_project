                        ...
                        <div class="card" style="width: 20rem;">
                            ...
                            <h5 class="card-title">รายละเอียด : <?= $r1->pro_detail ?></h5>
                                ...
                                if ($r->em_user == $r1->em_user) {
                                    ?>
                                    <center><a href="f_add_pro_dep.php?pro_id=<?= $r1->pro_id ?>" class="btn btn-primary"> เพิ่มแผนกที่เกี่ยวข้อง </a></center>
                                    <p></p>
                                    <a href="project.php?pro_id=<?= $r1->pro_id ?>" class="btn btn-success"> เข้า </a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                    <a href="f_proname_update.php?pro_id=<?= $r1->pro_id ?>" class="btn btn-warning"> แก้ไข </a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="delete_project.php?pro_id=<?= $r1->pro_id ?>" class="btn btn-danger"> ลบ </a>
                                <?php
                                }else {
                                ?>
                                    <center>ไม่ได้เข้าร่วม</center>
                                <?php
                                }
                                ?>
                            </div>
